...
const IconCompass = (props) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M14 10l-2 1m0 0l-2-1m2 1v2.5M14 10a4 4 0 11-8 0V7H6a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V9a2 2 0 00-2-2h-1.5M14 10h4.5a2 2 0 012 2v10a2 2 0 01-2 2H2a2 2 0 01-2-2V12a2 2 0 012-2h4.5M15 10v4.5a2 2 0 01-2 2H9.5a2 2 0 01-2-2V10M12 15h.01M12 12V9m-2 1h4m-4 4h4M12 20h.01M12 4V1m0 19v3m9-9h3M1-9h-3"
    />
  </svg>
);
const IconLightbulb = (props) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M9.663 17.48a1 1 0 00-.174.484l-.512 1.638C8.598 20.472 9.69 21 11 21h2c1.31 0 2.402-.528 1.923-1.428l-.512-1.638a1 1 0 00-.174-.484M15 11a3 3 0 11-6 0 3 3 0 016 0zm3 0v.01M6 11v.01M12 3v.01M12 19v.01M21 9v.01M3 9v.01M12 15a4 4 0 100-8 4 4 0 000 8z"
    />
  </svg>
);
...
const IconRings = (props) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m21-12a2 2 0 100-4m0 4a2 2 0 110-4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4"
    />
  </svg>
);

// --- Modern Value Card with Advanced Hover Effects ---
const ModernValueCard = ({
  title,
  description,
  icon: Icon,
  color,
    ...
    >
      ...
      >
        ...
        <div className="relative z-10">
          ...
          {/* Content */}
          <motion.h3 className="text-2xl font-bold mb-3 text-gray-900 group-hover:text-gray-800 transition-colors duration-300">
            {title}
          </motion.h3>

          <motion.p className="text-lg text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
            {description}
          </motion.p>
          ...
          >
            ...
            <motion.div variants={sectionTextVariants}>
              ...
              <motion.p className="text-lg md:text-xl text-gray-700 mb-6 leading-relaxed border-l-4 border-purple-500 pl-6 py-3 bg-purple-50/50 rounded-lg">
                At our core, we believe that every moment tells a story worth
                preserving. Our mission is to transform fleeting instants into{" "}
                <strong>timeless visual narratives</strong> that resonate with
                emotion and authenticity.
              </motion.p>

              <motion.p className="text-lg md:text-xl text-gray-600 mb-12 leading-relaxed">
                We don't just take pictures; we craft visual heirlooms that
                capture the essence of your journey, the depth of relationships,
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16 lg:gap-20">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-700 mb-8 leading-relaxed">
                In 2018, we officially opened our studio with a simple
                philosophy: every photograph should tell a story. Today, our
                team continues this legacy, blending technical expertise with
                artistic vision to create images that preserve feelings for
                generations to come.
              </p>
